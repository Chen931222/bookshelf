...
const PAGE_FIX = {
  // 《傷心咖啡店之歌》直排小說，兩張把頁碼讀錯，會和真正的那頁撞頁碼被去重丟掉：
  'IMG_5173': '5',    // 推薦序，agent 讀成 8；內文接 p.4「朱少麟的字彙」，轉正確認是 5，真正的 p.8 是 IMG_5176
  'IMG_5185': '86',   // 內文，agent 讀成 60；夾在 p.85（5184）與 p.87（5186）之間、內容連續，實為 86，否則會被掃進推薦序
  'IMG_5269': '268',  // 內文，agent 讀成 266；書眉放大是 268，真正的 p.266 是 IMG_5267
  'IMG_5109': '134-135',
  'IMG_5111': '138-139',
  'IMG_5112': '140-141',
  'IMG_5113': '164-165',
